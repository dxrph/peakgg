    ...
    <PeakMotion>
      <main className="site-shell">
        <div className="cinema-backdrop" aria-hidden="true">
          <img className="cinema-frame frame-hero" src="/assets/peakgg-hero-v4.webp" alt="" />
          <img className="cinema-frame frame-story" src="/assets/peakgg-story-v4.webp" alt="" />
          <img className="cinema-frame frame-team" src="/assets/peakgg-team-v4.webp" alt="" />
        ...
        <section className="hero" id="top">
          ...
          <div className="hero-art hero-console">
            <img src="/assets/peakgg-hero-v4.webp" alt="Arena cartoon competitiva PeakGG con punto di cattura" />
        ...
        <section className="image-story cinema-chapter" data-frame="story" aria-label="La storia PeakGG">
          <img src="/assets/peakgg-story-v4.webp" alt="Mappa cartoon PeakGG con corsie e obiettivi competitivi" />
        ...
        <section className="team-poster cinema-chapter" data-frame="team" aria-label="Community PeakGG">
          <img src="/assets/peakgg-team-v4.webp" alt="Cinque droni mascotte formano una squadra PeakGG" />
