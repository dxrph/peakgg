...
const mockPlayers = [
  { rank: 1, name: "PhantomX", elo: 3120, winrate: "68%", kd: "1.42", team: "Peak Kings", region: "EU-W" },
  { rank: 2, name: "NightShade", elo: 2891, winrate: "65%", kd: "1.38", team: "Void Reapers", region: "EU-W" },
  ...
  { rank: 5, name: "ShadowReaper", elo: 2254, winrate: "60%", kd: "1.26", team: "Shadow Corp", region: "EU-N" },
  { rank: 6, name: "CyberJett", elo: 1821, winrate: "59%", kd: "1.24", team: "—", region: "EU-W" },
  { rank: 7, name: "FrostByte", elo: 1598, winrate: "58%", kd: "1.21", team: "Ice Protocol", region: "EU-N" },
];
  ...
  return (
    <section className="py-24 bg-background">
      <div className="container">
        ...
        >
          <div className="grid grid-cols-[2.5rem_1fr_auto_4rem] md:grid-cols-[2.5rem_1fr_auto_5rem_4.5rem_4rem_5rem_4rem] gap-3 px-4 py-3 bg-secondary/50 text-xs text-muted-foreground font-display uppercase tracking-widest">
            <span>#</span>
            <span>Player</span>
            <span>Rank</span>
            ...
            <span className="text-right hidden md:block">Region</span>
          </div>

          {mockPlayers.map((p) => (
            <div key={p.name}
              className="grid grid-cols-[2.5rem_1fr_auto_4rem] md:grid-cols-[2.5rem_1fr_auto_5rem_4.5rem_4rem_5rem_4rem] gap-3 px-4 py-3 border-t border-border hover:bg-secondary/30 transition-colors items-center"
            >
