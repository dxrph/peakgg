  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-6 right-6 z-[60] w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300",
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "pkw fixed z-[60] bottom-24 right-6 w-[420px] h-[720px] rounded-2xl",
              "max-h-[calc(100vh-7rem)]",
              "max-sm:inset-0 max-sm:w-full max-sm:h-full max-sm:max-h-none max-sm:rounded-none max-sm:bottom-0 max-sm:right-0 max-sm:left-0",
            )}
