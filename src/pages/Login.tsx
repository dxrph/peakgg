          ...
          <form onSubmit={submit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" autoComplete="email" placeholder="player@email.com" value={email} onChange={(e) => setEmail(e.target.value)} className="h-14 pl-11 bg-card/65 border-white/10 rounded-none" disabled={isLoading} />
              </div>
            </div>
